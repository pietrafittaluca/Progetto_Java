...
public class Contenuto_principale extends Contenuto
{
    String col_link;
    Float col_molto_positivo, col_positivo, col_neutrale, col_negativo, col_molto_negativo;
    Button btn_link, btn_salva;

    public Contenuto_principale(String nome_offerta, String citta, String tipo, Float molto_positivo, Float positvo, Float neutrale, Float negativo, Float molto_negativo, String link)
    {
